...
<head><meta http-equiv="Content-Type" content="text/html; charset=gbk">
  ...
  <meta name="renderer" content="webkit"><title>我是文化达人/体育达人</title><!--[if lte IE 9]>
 ...
 /*  (function(){
      ...
      if( mobilecheck() ) {
        window.location.href = '/mynutzdeom/home/mobile';
      }
    })();*/
  </script></head><body><div class="top_nav"><div class="username"><i></i></div>
  <a class="btn download disabled" href="javascript:;">下载为图片</a>
  <a class="btn weibo disabled" href="javascript:;">发送到新浪微博</a>
  <a class="btn share disabled" href="javascript:;"  style="visibility: hidden;">分享到朋友圈</a>
  <div class="weixin_share"><p>微信扫描二维码</p><div id="qrcode"></div>
    <i><b></b></i></div></div>
<div class="wrapper"><div class="preview_area" id="canvas"><div class="preview_area_w">
  ...
  <div class="edit_area"><span class="arrow"></span><div class="edit_area_w">
    <form id="upload_form" method="post" target="callback_frame" enctype="multipart/form-data" action="${base}/mynutzdeom/home/upload">
      <h3><i class="number number1"></i> <span>请上传人物照片</span></h3><div class="app_img">
      <label id="upload_bg" for="app_upload">
        <input type="file" id="app_upload" name="image" accept="image/*">
    ...
    <form id="main_form" method="post" target="callback_frame" action="${base}/mynutzdeom/home/getInfo">
    <h3><i class="number number2"></i> <span>请输入人物描述</span></h3>
    <div class="app_dec"><div class="dec_type"><span>
	<input type="radio" name="style" id="type_a" checked="" value="1"> <b>爱…还爱…</b></span>
    <span style="visibility: hidden;"><input type="radio" name="style" id="type_b" value="2"> <b>会…还会…</b></span></div><div class="story">
    <div class="dec_input"><input type="text" value="爱" name="word[]" class="dec_text default" autocomplete="off"></div>
    <div class="dec_input"><input type="text" value="爱" name="word[]" class="dec_text default" autocomplete="off"></div>
    <div class="dec_input"><input type="text" value="爱" name="word[]" class="dec_text default" autocomplete="off"></div>
      <div class="dec_input name"><div class="gender">体育达人</div><input type="text" name="identity" class="dec_text" autocomplete="off">
        <div class="gender_list" ><div><input type="radio" name="gender" id="boy" checked="" value="1"><b>体育达人</b></div><div>
          <input type="radio" name="gender" id="girl" value="2"> <b>文化达人</b>
          <%--<input type="radio" name="gender" id="obj" value="2"> <b>其他达人</b>--%>
        </div>
        </div>
      </div>

      <div class="dec_input" style="visibility: hidden;"><input type="text" value="爱" name="word[]" class="dec_text default" autocomplete="off"></div>
    <div class="dec_input" style="visibility: hidden;"><input type="text" value="爱" name="word[]" class="dec_text default" autocomplete="off" ></div>
      <div class="dec_input" style="visibility: hidden;"><input type="text" value="爱" name="word[]" class="dec_text default" autocomplete="off" type="hidden"></div>
      <div class="dec_input" style="visibility: hidden;"><input type="text" value="爱" name="word[]" class="dec_text default" autocomplete="off" type="hidden"></div>
     <div class="dec_input" style="visibility: hidden;"><input type="text" value="爱" name="word[]" class="dec_text default" autocomplete="off" type="hidden"></div>
     <div class="dec_input" style="visibility: hidden;"><input type="text" value="还爱" name="word[]" class="dec_text default" autocomplete="off" type="hidden"></div>

    </div>
    </div>
    <input style="visibility: hidden;" id="image_field" name="image">
    </form>
...
<script src="${base}/js/main.js"></script><script>
  // Google
  (function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){
            (i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),
          m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)
  })(window,document,'script','${base}/js/analytics.js','ga');

  //ga('create', 'UA-49819160-1', '${base}');
  //ga('send', 'pageview');
