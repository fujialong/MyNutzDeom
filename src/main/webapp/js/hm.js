(function() {
    var h = {},
        mt = {},
        c = {
            id: "482e5a238e881dd62851ca123d8b11f3",
            dm: [""],
            js: "",
            etrk: [],
            icon: '',
    ...
    (mt.o.U = function() {
        ...
        (function() {
            if(!f)
                if(f = s, "complete" === document.readyState) a.w = s;
        ...
        return function(d) {
            switch(typeof d) {
                ...
                default:
                    ...
                    e = mt.j.stringify;
                    for(k in d)
                        if(Object.prototype.hasOwnProperty.call(d, k)) switch(l =
                            d[k], typeof l) {
                            case "undefined":
                            case "unknown":
                            case "function":
    ...
    (function() {
        ...
        function b() {
            ...
            if((!n || !l) && e && m) u = s, p = +new Date;
            else if(n && l && (!e || !m)) u = w, q += +new Date - p;
            n = e;
            l = m;
            y = setTimeout(b, 100)
        }
    ...
    (function() {
        ...
        var f = mt.lang,
            ...
            e = {
                ...
                fa: function() {
                    if(0 < e.p.length)
                        for(var a = 0, b = e.p.length; a < b; a++) e.L(e.p[a]);
                    e.p = t
                },
                L: function(a) {
                    var b = a[0];
            ...
            if(window.performance && performance.timing && "undefined" !== typeof h.b) {
                ...
                var e = function() {
                    ...
                    var l = a.match(/^(http[s]?:\/\/)?([^\/]+)(.*)/) || [],
                        u = t;
                    b = t;
                    if("/" === l[2] || "/" === l[2]) u = f.i(a, "qid"), b = f.i(a, "click_t");
                    a = u;
                    e.qid = a != t ? a : "";
